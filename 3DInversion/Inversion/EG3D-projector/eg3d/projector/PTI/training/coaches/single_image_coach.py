...
class SingleImageCoach(BaseCoach):
    ...
    def train(self, image_path, w_path, dataset_json_path):
        ...
        for i in tqdm(range(hyperparameters.max_pti_steps)): # hyperparameters.max_pti_steps
        ...
        with torch.no_grad():
            ...
            Image.fromarray(vis_img[0].cpu().numpy(), 'RGB').save(f'{os.path.dirname(w_path)}/{image_name}_pti.png')
