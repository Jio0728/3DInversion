    ...
    for step in tqdm(range(num_steps)):
        ...
        if step == num_steps-1: #step % image_log_step == 0 
            with torch.no_grad():
                ...
                # PIL.Image.fromarray(vis_img[0].cpu().numpy(), 'RGB').save(f'{outdir}/{step}.png') # Original author intended to save images every 5 steps, but I changed to save only the last step
